...
$query_buscar = $pdo->prepare("SELECT tatuador.*, profileimg.id AS imageId, profileimg.imgName, profileimg.imgRandomName FROM tatuador INNER JOIN profileimg ON profileImgId = profileimg.id where email = :email and senha = :senha ");
