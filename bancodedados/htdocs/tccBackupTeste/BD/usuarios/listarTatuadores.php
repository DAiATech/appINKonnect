...
$query = $pdo->prepare("SELECT tatuador.*, profileimg.imgRandomName FROM tatuador inner join profileimg on  profileImgId = profileimg.id 
WHERE tatuador.id != $usuarioId 
